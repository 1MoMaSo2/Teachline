...
$sel = $connection->prepare("SELECT * FROM training_courses_mast WHERE training_courses_type_book_mast = 'تخصصی' AND training_courses_education_basic_mast = 'یازدهم' ");
$sel->execute();
    ...
    <section class="bg-dark align-items-center d-flex" style="background:url(assets/images/pattern/04.png) no-repeat center center; background-size:cover;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Title -->
                    <h1 class="text-white fs-2">دروس تخصصی پایه یازدهم هنرستان</h1>
                    <!-- Breadcrumb -->
                    <div class="d-flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                <li class="breadcrumb-item"><a href="index.php">صفحه اصلی</a></li>
                                <li class="breadcrumb-item"><a href="eleventh-specialized-category.php">دسته بندی تخصصی یازدهم</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
                                            <h5 class="card-title fw-normal"><a href="course-detail.php?course=<?php echo htmlentities($training_courses['training_courses_name_mast']); ?>"><?php echo $training_courses['training_courses_name_mast']; ?></a></h5>
                                        </div>
                                        <!-- Info -->
