        ...
        <div class="container">
            <div class="row align-items-center justify-content-xl-between g-4 g-md-5">
                ...
                <div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
                    ...
                    <h1 class="mb-4 display-7"><?php echo $_SESSION['full_name'];?>     عزیز به مدرسه آنلاین TeachLine خوش آمدی
                    </h1>
                    <?php }else{ ?>
                        <h1 class="mb-4 display-7">  خوش آمدید به مدرسه آنلاین TeachLine</h1>
                    <?php } ?>
                    <!-- Content -->
                    <br>
                    <!-- Search bar -->
                    ...
                    <div class="row g-3 mb-3 mb-lg-0">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <!-- Icon -->
                                <div class="icon-lg fs-4 text-orange bg-white bg-opacity-10 rounded"><i class="bi-book-half"></i></div>
                                <!-- Info -->
                                <div class="ms-3">
                                    <div class="d-flex">
                                        <h4 class="purecounter fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="<?php echo $training_coursess ?>" data-purecounter-delay="100"></h4>
                                    </div>
                                    <div>دوره آموزشی</div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <!-- Icon -->
                                <div class="icon-lg fs-4 text-light bg-white bg-opacity-10 rounded"><i class="fas fa-tv text-purple"></i></div>
                                <!-- Info -->
                                <div class="ms-3">
                                    <div class="d-flex">
                                        <h4 class="purecounter fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="<?php echo $training_course_meeting ?>" data-purecounter-delay="100"></h4>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <!-- Icon -->
                                <div class="icon-lg fs-4 text-primary bg-white bg-opacity-10 rounded"><i class="fas fa-user-tie"></i></div>
                                <!-- Info -->
                                <div class="ms-3">
                                    <div class="d-flex">
                                        <h4 class="purecounter fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="<?php echo $count_teachers?>" data-purecounter-delay="100">0</h4>
                                    </div>
                                    <div>دبیر</div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <!-- Icon -->
                                <div class="icon-lg fs-4 text-success bg-white bg-opacity-10 rounded"><i class="fas fa-user-graduate"></i></div>
                                <!-- Info -->
                                <div class="ms-3">
                                    <div class="d-flex">
                                        <h4 class="purecounter fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="<?php echo $count_students ?>" data-purecounter-delay="100">0</h4>
                                    </div>
                                    <div>هنرجو</div>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 col-xl-6 text-center position-relative">
                    ...
                    <div style="margin-left: 150px" class="p-3 card card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle me-9 z-index-1 d-none d-xl-block">
                        <div class="d-flex justify-content-between">
                            <!-- Info -->
                            <div class="text-start ms-3">
                                <h6 class="mb-0">عضو این مدرسه باشید</h6>
                                <!-- Button -->
                                <a href="sign-up.php" class="btn btn-sm btn-primary-soft mt-3 mb-0" style="margin-right: 25px">ثبت نام</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" position-relative">
                        ...
                        <!-- Image -->
                        <img style="border-radius: 50px ; width: 64% ; margin-bottom: 10px" src="assets/images/element/06.svg" class="position-absolute bottom-0 start-50 translate-middle-x"  alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 text-center mx-auto">
                    ...
                    <p class="mb-0">با انتخاب نوع درس و پایه تحصیلی مورد نظر , آموزش ها را مشاهده کنید</p>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="assets/images/courses/o10.jpg" alt="">
                        <!-- Image overlay -->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="assets/images/courses/o11.png" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="assets/images/courses/o12.png" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="assets/images/courses/t10.jpg" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="assets/images/courses/t11.png" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <!-- Image -->
                    <div class="card card-metro overflow-hidden rounded-3">
                        <img src="assets/images/courses/t12.png" alt="">
                        <!-- Image overlay -->
                        <div class="card-img-overlay d-flex">
                            <!-- Info -->
                            <div class="mt-auto card-text">
                        ...
                        <div class="col-11 mx-auto position-relative">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 text-lg-end">
                                    <a href="instructor/instructor-sign-up.php" class="btn btn-success mb-0">ثبت درخواست</a>
                                    <a href="instructor/instructor-sign-in.php" class="btn btn-success mb-0">ورود به پنل</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--<script src="script/check-online.js"></script>-->
