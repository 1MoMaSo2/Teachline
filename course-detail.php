...
$send = $connection->prepare("SELECT * FROM training_courses_mast WHERE training_courses_name_mast=?");
$send->bindValue(1, $array['course']);
$send->execute();
$course = $send->fetchAll(PDO::FETCH_ASSOC);

$send = $connection->prepare("SELECT * FROM training_course_meetings_mast WHERE training_course_meetings_course_name_mast=?");
$send->bindValue(1, $array['course']);
$send->execute();
$meetings_course = $send->fetchAll(PDO::FETCH_ASSOC);

foreach ($course as $courses){}

$tags = explode("," , $courses['training_courses_tag_mast']);
...
<section class="bg-light py-0 py-sm-5">
	<div class="container">
		<div class="row py-5">
                <div class="col-lg-8">
				<!-- Title -->
				<h1 class="fs-3"><?php echo htmlentities($courses['training_courses_name_mast']); ?></h1>
				<!-- Content --><br>
                    <ul class="list-inline mb-1">
                        <li class="list-inline-item h5 fw-light mb-1 mb-sm-0"><i class="fas fa-school text-danger me-2"></i><?php echo htmlentities($courses['training_courses_education_basic_mast']); ?></li>
                        <br>
                        <li style="margin-top: 10px" class="list-inline-item h5 fw-light mb-1 mb-sm-0"><i class="fa fa-table text-blue me-2"></i><?php echo htmlentities($courses['training_courses_field_study_mast']); ?></li>
                        <br>
                        <li style="margin-top: 10px" class="list-inline-item h5 fw-light mb-1 mb-sm-0"><i class="fas bi-book text-orange me-2"></i><?php echo htmlentities($courses['training_courses_type_book_mast']); ?></li>
                        <br>
                        <li style="margin-top: 10px" class="list-inline-item h5 fw-light mb-1 mb-sm-0"><i class="fas bi-person text-purple me-2"></i><?php echo htmlentities($courses['training_courses_teacher_mast']); ?></li>
                        <br>
                        <li style="margin-top: 10px" class="list-inline-item h5 fw-light mb-1 mb-sm-0"><i class="fas bi-calendar-date text-success me-2"></i>آخرین به روزرسانی : <?php echo jdate('Y/m/d' , $courses['training_courses_date_update_course_mast']); ?></li>
                    </ul>
			</div>
        </div>
	</div>
					...
					<div class="card-body p-4">
						<div class="tab-content pt-2" id="course-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="course-pills-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
								...
								<p class="mb-3"><?php echo $courses['training_courses_description_mast']; ?></p>
							</div>
							<!-- Content END -->
...
<!--                                            <!-- Info -->
<!--                                            <h2 class="mb-3" style="margin-right: 44%">ویدیو</h2>-->
<!--                                            <hr>-->
<!--                                            <div class="d-flex justify-content-between align-items-center">-->
<!--                                                <video style="width: 65% ; margin-right: 17%" src="assets/upload/course/--><?php //echo $meetings_course['training_course_meetings_link_mast']; ?><!--" controls></video>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <!-- Video END -->
