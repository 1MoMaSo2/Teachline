...
$search = $connection->prepare("SELECT * FROM training_courses_mast WHERE training_courses_name_mast LIKE '%$target%' ");
$search->execute();
$training_course = $search->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    <div class="d-flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="search-content.php">جستجوی دوره</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="pt-5">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <h3> نتایج جست و جو برای " <?php echo $target ?> " </h3>
