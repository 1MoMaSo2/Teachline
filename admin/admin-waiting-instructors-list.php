...
$sel = $connection->prepare("SELECT * FROM teacher_mast WHERE teacher_status_mast = '0' ");
$sel->execute();
...
if (isset($_GET['id'])) {
    ...
    $send = $connection->prepare("DELETE FROM teacher_mast WHERE id_teacher_mast=?");
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="admin-accept-instructors-list.php?id=<?php echo $teachers['id_teacher_mast']; ?>"><div class="badge bg-success text-white rounded-pill">تایید</div></a>
                                    <a href="#"
                                       class="badge bg-danger text-white rounded-pill"
                                       onclick="confirmDelete('<?php echo $teachers['id_teacher_mast']; ?>'); return false;"><i class="fas fa-fw fa-times">رد کردن</i></a>
                                </td>
                            </tr>
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "admin-waiting-instructors-list.php?id=" + id;
            }
        });
    }
</script>
