    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto text-center">
                <p class="text-center">
                    از این بخش برای اضافه کردن یک دوره به مدرسه آنلاین TeachLine استفاده کنید.
                    پس از اتمام افزودن دوره، میتوانید در بخش لیست دوره ها،
                    دوره مورد نظر را از بخش مدیریت جلسات دوره انتخاب و برای آن ویدیو آموزشی بارگذاری کنید.
                </p>
            </div>
        </div>
        ...
        <div class="card bg-transparent border rounded-5 mb-4">
            ...
            <div id="stepper" class="bs-stepper stepper-outline">
                ...
                <form method="post" action="/teachline/public/teacher/create-course">
                    ...
                    <div style="margin-right: 10%; margin-left: 10%" class="mb-4">
                        ...
                        >
                            ...
                            <?php foreach ($educationBasics as $educationBasic): ?>
                                ...
                                <option
                                        value="<?= htmlspecialchars($educationBasic['education_basic_name_mast']) ?>"
                                >
                                    <?= htmlspecialchars($educationBasic['education_basic_name_mast']) ?>
                                </option>
                    ...
                    <div style="margin-right: 10%; margin-left: 10%" class="mb-4">
                        ...
                        >
                            ...
                            <option value="همه رشته ها">
                                همه رشته ها
                            </option>

                            <option value="ویژه کنکوری ها">
                                ویژه کنکوری ها
                            </option>
                            ...
                            <?php foreach ($fieldStudies as $fieldStudy): ?>
                                ...
                                <option
                                        value="<?= htmlspecialchars($fieldStudy['field_study_name_mast']) ?>"
                                >
                                    <?= htmlspecialchars($fieldStudy['field_study_name_mast']) ?>
                                </option>
                    ...
                    <div style="margin-right: 10%; margin-left: 10%" class="mb-4">
                        ...
                        >
                            ...
                            <?php foreach ($typeBooks as $typeBook): ?>
                                ...
                                <option
                                        value="<?= htmlspecialchars($typeBook['type_book_mast']) ?>"
                                >
                                    <?= htmlspecialchars($typeBook['type_book_mast']) ?>
                                </option>
